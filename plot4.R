...
plot(ds1$newTime, ds1$Global_active_power, xlab="", ylab="Global Active Power", type="l")
...
plot(ds1$newTime, ds1$Voltage, xlab="datetime", ylab="Voltage", type="l")

plot(ds1$newTime, ds1$Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="l")
